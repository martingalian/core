    ...
    public function seedNotifications(): void
    {
        $notifications = [
            ...
            [
                ...
                'usage_reference' => 'Binance/UpdatePricesCommand WebSocket error callback line 143',
            ...
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 473',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 338',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 374',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 407',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 440',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendAccountStatusNotification() via sendThrottledNotification() line 215',
                'default_severity' => 'high',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendAccountStatusNotification() via sendThrottledNotification() line 228',
            ...
            [
                ...
                'usage_reference' => 'NotificationLogObserver::handleEmailBounce() line 79',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            ...
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 523',
                'default_severity' => 'high',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() lines 556, 591',
                'default_severity' => 'critical',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendAccountStatusNotification() via sendThrottledNotification() line 241',
                'default_severity' => 'high',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendAccountStatusNotification() via sendThrottledNotification() line 254',
                'default_severity' => 'high',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 627',
                'default_severity' => 'high',
                'user_types' => ['user'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ApiRequestLog/SendsNotifications::sendApiExceptionNotificationToAdmin() line 661',
                'default_severity' => 'critical',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
            [
                ...
                'usage_reference' => 'ExchangeSymbol/SendsNotifications::sendDelistingNotification() line 140',
                'default_severity' => 'high',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
            ...
            [
                ...
                'usage_reference' => 'GetCMCIDForSymbolJob lines 297, 312',
                'default_severity' => 'medium',
                'user_types' => ['admin'],
                'is_active' => true,
            ],
